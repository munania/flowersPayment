...
<body>
	...
	<div id="navbar" class="navbar navbar-default"> <!--navbar navbar-default Begin -->
		...
		<div class="navbar-collapse collapse" id="navigation"><!--"navbar-collapse collapse Begin -->
			...
			<a href="cart.php" class="btn navbar-btn right"> <!--btn navbar-btn btn-primary right Begin -->
			...
			<div class="navbar-collapse collapse right"> <!--"navbar-collapse collapse right Brgin -->
				<button class="btn navbar-btn" type="button" data-toggle="collapse" data-target="#search"> <!--btn btn-primary navbar-btn Begin -->
			...
			<div class="collapse clearfix" id="search"> <!--collapse clearfix Begin -->
				...
				<form method="get" action="results.php" class="navbar-form"> <!--navbar-form Begin -->
					<div class="input-group"> <!--input-group Begin -->
						...
						<button type="submit" name="search" value="Search" class="btn"> <!--btn btn-primary Begin -->
