					...
					<form action="cart.php" method="post" enctype="multipart/form-data"> <!--form Begin -->
						...
						<div class="table-responsive"> <!--table-responsive Begin -->
								...
								<tbody> <!--tbody Begin -->
									...
									<tr> <!--tr Begin -->
										...
										<td>
											...
											<a style="color: #65388B;" href="<?php echo $pro_url; ?>"> <?php echo $product_title; ?></a>
							...
							<div class="form-inline pull-right"> <!--form-inline Begin -->
								...
								<div class="form-group"> <!--form-group Begin -->
									...
									<input type="submit" class="btn" value="Use Coupon" name="apply_coupon">									
						...
						<div class="box-footer"> <!--box-footer Begin -->
							...
							<div class="pull-right"> <!--pull-right Begin-->
								...
								<button type="submit" name="update" value="Update Cart" class="btn details"> <!--btn btn-default Begin -->
