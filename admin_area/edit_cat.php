 				...
 				<form action="" class="form-horizontal" method="post" enctype="multipart/form-data"> <!-- form-horizontal Begin -->
                    ...
                    <div class="form-group"> <!-- form-group Begin -->
                        ...
                        <div class="col-md-6"> <!-- col-md-6Begin -->
                            ...
                            <img src="other_images/<?php echo $cat_image; ?>" alt="<?php echo $cat_title; ?>" width="70" height="70"> 
                    ...
                    <div class="form-group"> <!-- form-group Begin -->
                        ...
                        <div class="col-md-6"> <!-- col-md-6Begin -->
                            ...
                            <input value="Submit Category" name="update" type="submit" class="form-control btn btn-primary">
