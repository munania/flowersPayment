...
<?php
	...
	while ($row_cart = mysqli_fetch_array($run_cart)) {
		...
		$insert_pending_order = "insert into pending_orders (customer_id, invoice_number, product_id, qty, order_status ) values ('$customer_id', '$invoice_no', '$pro_id', '$pro_qty', '$status')";
